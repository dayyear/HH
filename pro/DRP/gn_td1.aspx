<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gn_td1.aspx.cs" Inherits="pro_DRP_gn_td1" %>
...
<head id="Head1" runat="server">
    ...
    <!--<script src="gn_td1.js" type="text/javascript"></script>-->
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        if (VERB.toUpperCase() === "COPY")
                            window.location.href = "gn_td1.aspx?VERB=UPDATE&ID=" + response.message;
                        else
                            window.location.href = "gn_td1.aspx?VERB=SELECT&ID=" + response.message;
                    }
                    else {
...
<div id="wrapper">
    ...
    <div class="box">
        <table>
            ...
            <tr>
                ...
                <th>发布时间</th>
                <td><span id="FBSJ" runat="server" /></td>
            </tr>
            <%}%>
            </tbody>
        </table>
    ...
    <div class="toolbar">
        <%if (VERB.ToUpper() == "SELECT"){%>
              <a href="gn_dd1.aspx?VERB=INSERT&TD_ID=<%=ID%>" class="btn" id="预定">预定</a>
        <%}%>
        <%if (VERB.ToUpper() == "SELECT" && User.IsInRole("ADMIN")){%>
              <a href="gn_td1.aspx?VERB=UPDATE&ID=<%=ID%>" class="btn" id="编辑">编辑</a>
