<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gn_dd1.aspx.cs" Inherits="pro_DRP_gn_dd1" %>
        ...
        function save() {
            $.ajax({ type: "POST",
                ...
                success: function (response) {
                    if (response.success) {
                        alert("保存成功");
                        window.location.href = "gn_dd1.aspx?VERB=UPDATE&ID=" + response.message;
                    }
                    else {
...
<div id="wrapper">
    ...
    <div class="box">
        ...
        <tr>
            ...
            <th>行程</th>
            <td><span id="XC" runat="server"></span><!--<a target="_blank" href="gn_td_fj.aspx?ID=<%=TD_ID%>"><img src="../../pub/img/word.gif" alt="word" /></a>--></td>
        </tr>
        <tr>
            <th>已定</th>
            ...
            <th>发布时间</th>
            <td><span id="TD_FBSJ" runat="server"></span><!--<input type="text" name="<%if(VERB.ToUpper()!="INSERT") Response.Write("TD_");%>FBSJ" />--></td>
        </tr>
        </tbody>
        </table>
        </div>
